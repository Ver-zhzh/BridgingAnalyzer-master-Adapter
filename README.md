...
| 服务器版本 | 下载文件 | 说明 |
|------------|----------|------|
| **1.21+，1.8.9-1.12.2** | `BridgingAnalyzer-2.1.3.jar` | 最新版本，完整功能 |
| **1.20.4** | `BridgingAnalyzer-2.1.3-1.20.jar` | 1.20专门适配 |
| **1.19.2** | `BridgingAnalyzer-2.1.3-1.19.jar` | 1.19专门适配 |
| **1.18.1** | `BridgingAnalyzer-2.1.3-1.18.jar` | 1.18专门适配 |
| **1.16.5** | `BridgingAnalyzer-2.1.3-1.16.jar` | 1.16专门适配 |
| **1.15.2** | `BridgingAnalyzer-2.1.3-1.15.jar` | 1.15专门适配 |
| **1.14.4** | `BridgingAnalyzer-2.1.3-1.14.jar` | 1.14专门适配 |
| **1.13.2** | `BridgingAnalyzer-2.1.3-1.13.jar` | 1.13专门适配 |
